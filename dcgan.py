...
# Create the dataset
dataset = ImageDataset(root_dir=dataroot,
...
os.makedirs("PluGen/pretrained", exist_ok=True)
torch.save(netG.state_dict(), "PluGen/pretrained/netG.pt")
print("Saved: PluGen/pretrained/netG.pt")